...
internal enum Asset {
  ...
  internal enum Colors {
    ...
    internal static let priority1 = ColorAsset(name: "priority1")
    internal static let priority2 = ColorAsset(name: "priority2")
    internal static let priority3 = ColorAsset(name: "priority3")
    internal static let priority4 = ColorAsset(name: "priority4")
    internal static let priority5 = ColorAsset(name: "priority5")
