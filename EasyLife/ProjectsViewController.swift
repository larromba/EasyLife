...
class ProjectsViewController: UIViewController {
    ...
    private func newProject() {
        ...
        alertController.addAction(UIAlertAction(title: "OK".localized, style: .default, handler: { (_: UIAlertAction) in
...
extension ProjectsViewController: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, editActionsForRowAt indexPath: IndexPath) -> [UITableViewRowAction]? {
        let delete = UITableViewRowAction(style: .destructive, title: "Delete".localized, handler: { (_: UITableViewRowAction, _: IndexPath) in
        ...
        case 1:
            ...
            let prioritize = UITableViewRowAction(style: .normal, title: "Prioritize".localized, handler: { (_: UITableViewRowAction, _: IndexPath) in
                self.dataSource.prioritize(at: indexPath)
            })
            prioritize.backgroundColor = .lightGreen
            return [delete, prioritize]
        default:
            let deprioritize = UITableViewRowAction(style: .normal, title: "Deprioritize".localized, handler: { (_: UITableViewRowAction, _: IndexPath) in
